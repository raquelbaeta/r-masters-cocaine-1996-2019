...
# Variables: Annual wholesale and retail averages for all European countries in 
# Euro, as well as the "Weighted* average, in Euro", and "Euro-inflation-
# adjusted weighted* average, in 2020 Euro" for both wholesale and retail.
...
# Step 1.1: Load the retail price data from the Excel file "price_dollar_western
# _europe.xlsx" and specify the relevant sheet and range.
...
# 1.2: Use the %>% pipe operator from the "dplyr" package to perform a series of 
...
# 1.3: Reshape the data from wide to long format using the pivot_longer() 
...
# 2.2: Use the %>% pipe operator from the "dplyr" package to perform a series of 
# data manipulation steps.
...
# 2.3: Reshape the data from wide to long using the pivot_longer() function from 
...
# Step 3: Merge retail and wholesale price data. Use the full_join() function 
...
# named "cocaine_prices" that contains both retail and wholesale prices for each 
# country and year.
...
# 5.2: Use the %>% pipe operator from the "dplyr" package to perform a series of
# data manipulation steps.
...
# 5.3: Reshape the data from wide to long using the pivot_longer() function from 
# the "tidyr" package. This function helps transform yearly columns (1996 to 
# 2019) into a single "year" column and their corresponding values into 
# "wholesale" column.
...
# Step 6: Use the merge() function to combine the different average price and 
# wholesale data sets based on the "year" column. "all = 
...
# Step 7: Load and filter for the "Euro-inflation-adjusted weighted* average, 
...
# 7.2: Use the %>% pipe operator from the "dplyr" package to perform a series of 
# data manipulation steps.
...
# 7.3: Reshape the data from wide to long using the pivot_longer() function from
# the "tidyr" package. This function helps transform yearly columns (1996 to 
# 2019) into a single "year" column and their corresponding values into a 
# "wholesale" column.
...
# Step 8: Load the average inflation-adjusted wholesale price data and filter for 
# the "Euro-inflation-adjusted weighted* average, in 
# 2020 Euro" category.
...
# 8.2: Use the %>% pipe operator from the "dplyr" package to perform a series of 
# data manipulation steps.
...
# 8.3: Reshape the data from wide to long using the pivot_longer() function from 
# the "tidyr" package. This function helps transform yearly columns (1996 to 
# 2019) into a single "year" column and their corresponding values into a 
# "wholesale" column.
...
# Step 9: Use the merge() function to combine the different average retail and 
...
# Step 10: Use the merge() function to combine the different data sets based on 
# the "year" column. "all = TRUE" argument to ensure that all years are included 
...
# Step 11: Using the fwrite() function from the "data.table" package create two 
# CSV files named  "prices.csv" and "prices_avg.csv".
