...
# 4.3: Reshape the data from wide to long using the pivot_longer() function from the "tidyr" package. This function helps transform 
# yearly columns (1996 to 2019) into a single "year" column and their corresponding values into a "wholesale" column.
...
# yearly columns (1996 to 2019) into a single "year" column and their corresponding values in "wholesale" column.
...
# 7.2: Use the %>% pipe operator from the "dplyr" package to perform data manipulation steps.
