...
milex_dollar <- read_excel(file_path, sheet = "Current US$", skip = 5, 
                         range = "A6:AE199")
milex_dollar
...
# Assuming data frames are named filtered_milex_gdp and filtered_milex
merged_milex <- left_join(filtered_milex_gdp, filtered_milex, 
                         by = c("country", "year"))
