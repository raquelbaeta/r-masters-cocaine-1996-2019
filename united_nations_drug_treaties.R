...
un_stats <- summarised_data %>%
  summarize(mean_un1961 = mean(un1961), median_un1961 = median(un1961), 
            sd_un1961 = sd(un1961),
            mean_un1971 = mean(un1971), median_un1971 = median(un1971), 
            sd_un1971 = sd(un1971),
            mean_un1988 = mean(un1988), median_un1988 = median(un1988), 
            sd_un1988 = sd(un1988))
