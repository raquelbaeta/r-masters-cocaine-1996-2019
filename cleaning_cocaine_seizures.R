...
cocaine_data_long <- mutate(cocaine_data_long, seizures = ifelse(is.na(seizures), 0, seizures))

# Save as a .csv
write.csv(cocaine_data_long, file = "~/Desktop/working-sessions/cleaning_data/cocaine_data_long.csv", row.names = FALSE)
