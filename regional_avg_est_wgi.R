...
data$year_interval_3yr <- cut(
  data$year, breaks = seq(1996, 2019, by = 3), 
...
# Plot
east_asia_pacific_wgi_esitmates_plot <- ggplot(
  ...
  scale_color_manual(
    ...
    values = c("mean_CC_EST" = "#B3446C",
               ...
               "mean_VA_EST" = "#F08030",
               "mean_PV_EST" = "#FFC107"),
    labels = c("mean_CC_EST" = "Control of Corruption",  # Updated label
  ...
  theme(
    ...
    strip.background = element_rect(
      fill = "#ffffff", color = "lightgrey", size = 1, linetype = "solid")) +
...
ggsave("east_asia_pacific_wgi_esitmates_plot.pdf", 
       plot = east_asia_pacific_wgi_esitmates_plot, width = 12, height = 8)
ggsave("east_asia_pacific_wgi_esitmates_plot.png", 
       plot = east_asia_pacific_wgi_esitmates_plot, width = 12, height = 8)
...
# Plot
europe_central_asia_wgi_esitmates_plot <- ggplot(
  filtered_europe_central_asia_averages, aes(x = year_interval_3yr)) +
  
  geom_point(aes(y = mean_CC_EST, color = "mean_CC_EST"), size = 3) +
  geom_line(aes(y = mean_CC_EST, color = "mean_CC_EST", group = any_UN), 
            size = 2.5, alpha = 0.475) +
  
  geom_point(aes(y = mean_GE_EST, color = "mean_GE_EST"), size = 3) +
  geom_line(aes(y = mean_GE_EST, color = "mean_GE_EST", group = any_UN), 
            size = 2.5, alpha = 0.475) +
  
  geom_point(aes(y = mean_RQ_EST, color = "mean_RQ_EST"), size = 3) +
  geom_line(aes(y = mean_RQ_EST, color = "mean_RQ_EST", group = any_UN), 
            size = 2.5, alpha = 0.475) +
  
  geom_point(aes(y = mean_RL_EST, color = "mean_RL_EST"), size = 3) +
  geom_line(aes(y = mean_RL_EST, color = "mean_RL_EST", group = any_UN), 
            size = 2.5, alpha = 0.475) +
  
  geom_point(aes(y = mean_VA_EST, color = "mean_VA_EST"), size = 3) +
  geom_line(aes(y = mean_VA_EST, color = "mean_VA_EST", group = any_UN), 
            size = 2.5, alpha = 0.475) +
  
  geom_point(aes(y = mean_PV_EST, color = "mean_PV_EST"), size = 3) +
  geom_line(aes(y = mean_PV_EST, color = "mean_PV_EST", group = any_UN), 
            size = 2.5, alpha = 0.475) +
...
# Save the plot as a PDF/PNG
ggsave("europe_central_asia_wgi_esitmates_plot.pdf", 
       plot = europe_central_asia_wgi_esitmates_plot, width = 12, height = 8)
ggsave("europe_central_asia_wgi_esitmates_plot.png", 
       plot = europe_central_asia_wgi_esitmates_plot, width = 12, height = 8)
...
# Assuming your grouped data frame is named 'grouped_df'
...
# Plot
latin_america_caribbean_wgi_esitmates_plot <- ggplot(
  filtered_latin_america_caribbean_averages, aes(x = year_interval_3yr)) +
  ...
  scale_x_discrete(
    breaks = unique(filtered_latin_america_caribbean_averages$year_interval_3yr),
    labels = c("1996-1998", "1999-2001", "2002-2004", "2005-2007", "2008-2010",
               "2011-2013", "2014-2016", "2017-2019")) +
  facet_wrap(~any_UN, scales = "free_y", ncol = 1)
...
# Save the plot as a PDF/PNG
ggsave("latin_america_caribbean_wgi_esitmates_plot.pdf", 
       plot = latin_america_caribbean_wgi_esitmates_plot, width = 12, height = 8)
ggsave("latin_america_caribbean_wgi_esitmates_plot.png", 
       plot = latin_america_caribbean_wgi_esitmates_plot, width = 12, height = 8)
...
# Save the plot as a PDF/PNG
ggsave("middle_east_north_africa_wgi_esitmates_plot_plot.pdf", 
       plot = middle_east_north_africa_wgi_esitmates_plot, width = 12, height = 8)
ggsave("middle_east_north_africa_wgi_esitmates_plot_plot.png", 
       plot = middle_east_north_africa_wgi_esitmates_plot, width = 12, height = 8)
...
# Save the plot as a PDF/PNG
ggsave("north_america_wgi_esitmates_plot_wgi_esitmates_plot.pdf", 
       plot = north_america_wgi_esitmates_plot, width = 12, height = 8)
ggsave("north_america_wgi_esitmates_plot_wgi_esitmates_plot.png", 
       plot = north_america_wgi_esitmates_plot, width = 12, height = 8)
...
# Plot
south_asia_wgi_esitmates_plot <- ggplot(
...
# Save the plot as a PDF/PNG
ggsave("south_asia_wgi_esitmates_plot_plot.pdf", 
       plot = south_asia_wgi_esitmates_plot, width = 12, height = 8)
ggsave("south_asia_wgi_esitmates_plot_plot.png", 
       plot = south_asia_wgi_esitmates_plot, width = 12, height = 8)
...
# Plot
sub_saharan_africa_wgi_esitmates_plot <- ggplot(
...
# Save the plot as a PDF/PNG
ggsave("sub_saharan_africa_wgi_esitmates_plot.pdf", 
       plot = sub_saharan_africa_wgi_esitmates_plot, width = 12, height = 8)
ggsave("sub_saharan_africa_wgi_esitmates_plot.png", 
       plot = sub_saharan_africa_wgi_esitmates_plot, width = 12, height = 8)
